...
//  }
    ...
    private static void put(KVClient client, String collection, String key, String value) {
...
//                client = session.createRawClient();
                client = session.createTxnKVClient();
            } catch (Exception e) {
...
//    while (true) ;
    ...
    private static void runWrite(KVClient client, Channel<WriteAction> action, Channel<Long> timings) {
        new Thread(() -> {
